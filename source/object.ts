...
import type { AO, AF } from './index'
import { isEmpty, isObj } from './is'
...
const _mergeLeftHelper = (a: any, b: any) =>
...
/** 过滤值的为Empty的属性 */
export const filterEmpty: (d: AO | any[]) => any = R.filter(
	R.compose(
		R.not,
		isEmpty,
	)
